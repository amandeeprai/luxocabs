import { Component, ElementRef, EventEmitter, HostListener, Input, NgZone, OnDestroy, Output } from '@angular/core';
...
export class CarouselComponent implements OnDestroy {
   ...
   */
   ...
   public constructor(config: CarouselConfig, el: ElementRef, private ngZone: NgZone) {
